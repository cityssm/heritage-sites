  ...
  const refreshSearchResults = () => {
    ...
    for (const heritageSite of heritageSites) {
      ...
      if (includeSite) {
        ...
        (panelBlockElement.querySelector("[data-field='descriptionOfProperty']") as HTMLElement)
          .textContent = heritageSite.descriptionOfProperty;

        (panelBlockElement.querySelector("[data-field='civicAddress']") as HTMLElement)
          .textContent = heritageSite.civicAddress;

        (panelBlockElement.querySelector("[data-field='bylawNumber']") as HTMLElement)
          .textContent = heritageSite.bylawNumber;

        (panelBlockElement.querySelector("[data-field='datePassed']") as HTMLElement)
