...
(() => {
    ...
    const closeHeritageSiteModal = () => {
        ...
        (_a = document.querySelector('html')) === null || _a === void 0 ? void 0 : _a.classList.remove('is-clipped');
        (_b = document.querySelector('main')) === null || _b === void 0 ? void 0 : _b.removeAttribute('inert');
    };
    ...
    const openHeritageSiteModal = () => {
        ...
        modalElement.querySelector("[data-field='ownerName']").textContent =
            heritageSite.ownerName;
        ...
        (_b = document.querySelector('main')) === null || _b === void 0 ? void 0 : _b.setAttribute('inert', 'inert');
    ...
    <span data-field="designatedOrListed"></span><br />
      <span data-field="siteType"></span>
    </td>`;
    const refreshSearchResults = () => {
        ...
        for (const heritageSite of heritageSites) {
            ...
            for (const searchStringPiece of searchStringPieces) {
                if (!((_a = heritageSite.searchString) === null || _a === void 0 ? void 0 : _a.includes(searchStringPiece))) {
                    includeSite = false;
                    break;
                }
            }
            if (includeSite) {
                ...
                descriptionOfSiteAnchorElement.textContent =
                    heritageSite.descriptionOfSite;
                ...
                rowElement.querySelector("[data-field='datePassed']").textContent = heritageSite.datePassed;
                rowElement.querySelector("[data-field='siteType']").textContent = heritageSite.siteType;
                rowElement.querySelector("[data-field='designatedOrListed']").textContent = heritageSite.designatedOrListed;
                (_b = searchResultsTableElement.querySelector('tbody')) === null || _b === void 0 ? void 0 : _b.append(rowElement);
            }
        }
